      ...
      <div className="glass-panel mx-auto max-w-6xl rounded-2xl px-6 py-8">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            {/* Telegram */}
            <a href="https://t.me/raxva_net" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80">
            ...
            {/* X / Twitter */}
            <a href="https://x.com/raxva_net" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80">
            ...
            {/* Nostr */}
            <a href="https://npub.world/_@raxva.net" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80">
